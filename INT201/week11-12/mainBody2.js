...
console.log(firstDiv.getAttribute('class')) //return value of specified attribute 'name'
...
// create a new Attribute name 'owner' with value 'Pearmai'
firstDiv.setAttribute('owner' , 'Pearmai')
