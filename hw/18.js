...
// Instruction:
// - Write a JavaScript function convertTemperature that converts a temperature from Fahrenheit to Celsius, or from Celsius to Fahrenheit, based on a mode parameter.
// 18.1 The function should accept two arguments:
    // temperature (a number) and mode (a string). 
    //The mode argument can be either 'FtoC' for Fahrenheit to Celsius conversion or 'CtoF' for Celsius to Fahrenheit conversion.
// 18.2 Implement the conversion logic:
// • Fahrenheit to Celsius: (temperature - 32) * 5/9
// • Celsius to Fahrenheit: (temperature * 9/5) + 32
// 18.3 Return the converted temperature as a number If the mode is neither 'FtoC' nor 'CtoF', return a message 'Invalid mode. Please use "FtoC" or "CtoF"'.
// Initiate code:
